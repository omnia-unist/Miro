...
from networks.batchnorm_layer import BatchNormLayer
from networks.context_mod_layer import ContextModLayer
        ...
        if verbose:
            if use_context_mod:
                ...
                for cm_layer in self._context_mod_layers:
                    cm_num_weights += shapes_to_num_weights( \
