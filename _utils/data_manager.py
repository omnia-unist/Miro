...
Class DataManager
    Attributes:
        -num_samples_observed_so_far 
        -map_str_label_to int_label 
        -map_int_label_to_str_label
        -classes_per_task
        -num_classes_streamed_so_far 
        -num_task_so_far
    Methods: 
        -append_new_class: add a new class to classify; 
            -new_class: the string representing the name of the new label
        -append_new_task: add a new task with TASK_ID, classify objects with label INT_LABEL
"""
class DataManager(object):
    ...
    def append_new_task(self, task_id, int_label):
        ...
        # print(task_id, self.classes_per_task[task_id])
